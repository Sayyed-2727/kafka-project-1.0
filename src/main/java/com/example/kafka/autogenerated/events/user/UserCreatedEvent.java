 ...
 */
package com.example.kafka.autogenerated.events.user;
...
public class UserCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2764859594726954494L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserCreatedEvent\",\"namespace\":\"com.example.kafka.autogenerated.events.user\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"firstname\",\"type\":\"string\"},{\"name\":\"lastname\",\"type\":\"string\"},{\"name\":\"email\",\"type\":\"string\"},{\"name\":\"role\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\"}]}");
   ...
   */
  public UserCreatedEvent(java.lang.Long id, java.lang.CharSequence firstname, java.lang.CharSequence lastname, java.lang.CharSequence email, java.lang.CharSequence role, java.lang.Long timestamp) {
    this.id = id;
   ...
   */
  public static com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder newBuilder() {
    return new com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder();
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder newBuilder(com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder other) {
    if (other == null) {
      return new com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder();
    } else {
      return new com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder(other);
    }
  }
   ...
   * @return A new UserCreatedEvent RecordBuilder
   */
  public static com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder newBuilder(com.example.kafka.autogenerated.events.user.UserCreatedEvent other) {
    if (other == null) {
      return new com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder();
    } else {
      return new com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserCreatedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.autogenerated.events.user.UserCreatedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setFirstname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearFirstname() {
      firstname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setLastname(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearLastname() {
      lastname = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setEmail(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearEmail() {
      email = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setRole(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearRole() {
      role = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.autogenerated.events.user.UserCreatedEvent.Builder clearTimestamp() {
